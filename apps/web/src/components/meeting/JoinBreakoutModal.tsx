          ...
          {rooms && rooms.length > 0 ? (
            rooms.map((room, index) => {
              ...
              return (
                <div
                  key={room.id}
                  className="flex items-center justify-between gap-3 px-4 py-3 bg-[#222] hover:bg-[#2a2a2a] border border-[#333] hover:border-blue-500/40 rounded-xl transition-all duration-200 group"
                >
